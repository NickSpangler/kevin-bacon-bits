...
function FilmographyChallenge(props) {
    return (
        <div>
            ...
            <RoundResult round_result={props.round_result} actor={props.actor} history={props.history} current_movie={props.current_movie} actor_movies={props.actor_movies} getPossibleMovies={props.getPossibleMovies}/>
        </div>
    )
}
